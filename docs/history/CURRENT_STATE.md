...
- Локальная проверка `npm run verify:contacts` теперь дополнительно валидирует, что hero click-layer `rec861352716` / `1738735136250` ведёт именно в `site_plan`, а не в `site_meeting`.
