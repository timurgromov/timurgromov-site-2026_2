...
- Hero popup `Получить сценарий` показывает компактное preview материала с фото из основного hero сайта, но не даёт прямую ссылку на `/scenario/`; единственный CTA в popup ведёт в Telegram-бота.
