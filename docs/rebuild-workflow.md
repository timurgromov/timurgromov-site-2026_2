...
## 1. Purpose
Этот документ — рабочий план поддержки сайта `timurgromov-site-2026_2`.
...
- `timurgromov.ru` не трогать как деплой-цель;
...
6. `docs/do-not-break-this-site.md`
7. `docs/video-link-registry.md` для видео/Safari/VPS задач
8. `docs/github-pages-deploy.md` (перед любым deploy или если «не обновился сайт»)
9. `docs/section-map.md` (при необходимости)
10. export-файлы
11. только потом правки в коде.
